        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex justify-center w-full lg:w-2/3 ">
            <form
              ref={form}
              onSubmit={sendEmail}
              className=" p-8 rounded-lg shadow-lg  w-full space-y-6 transition-transform transform hover:scale-105 hover:shadow-2xl duration-300"
            >
              ...
              <button type="submit" className="fancy-button">
                <span className="fancy-transition"></span>
                <span className="fancy-gradient"></span>
                <span className="fancy-label">Send message</span>
              </button>
            </form>
          </div>
          ...
          <div className=" space-y-2 justify-center gap-8 text-lg w-full lg:w-1/3">
            <div>
              {" "}
              <h2 className="text-xl mb-2 font-bold text-gray-600 flex gap-2 items-center dark:text-gray-300">
                {" "}
                Address <FaHome />
              </h2>
            ...
            <h2 className="dark:text-gray-300 text-gray-600 font-bold pt-12">
              Follow Me
            </h2>
